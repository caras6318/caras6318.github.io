...
책에서 해당 구역을 기업 접속이라고 나누었음에도 기업(및 가정)에서의 액세스라고 설명하고 있으므로 명확하게 나누기가 애매한 부분인 것 같다.
